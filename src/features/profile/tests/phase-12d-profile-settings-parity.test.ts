...
describe("Phase 12D — Mystic Plus placeholder", () => {
  it("shows honest subscription placeholder without checkout", () => {
    ...
    expect(en.premium.webComingSoon).toContain("soon");
    expect(ru.premium.webComingSoon).toContain("скоро");
  });
});
